DGMTXD ; GENERATED FROM 'DGMT ENTER/EDIT DEPENDENTS' INPUT TEMPLATE(#468), FILE 408.22;03/14/16
 D DE G BEGIN
...
X24 S DGNFLD="@10"
 Q
25 D:$D(DG)>9 F^DIE17,DE S DQ=25,DW="0;11",DV="SX",DU="",DIFLD=.11,DLB="DID CHILD HAVE ANY INCOME/NET WORTH"
 S DE(DW)="C25^DGMTXD"
 S DU="1:YES;0:NO;"
 G RE
...
X26 S:'X Y="@998"
 Q
27 D:$D(DG)>9 F^DIE17,DE S DQ=27,DW="0;12",DV="SX",DU="",DIFLD=.12,DLB="WAS THE CHILD'S INCOME/NET WORTH AVAILABLE TO YOU"
 S DE(DW)="C27^DGMTXD"
 S DU="1:YES;0:NO;"
 G RE
