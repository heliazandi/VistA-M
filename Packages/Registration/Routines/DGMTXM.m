DGMTXM ; GENERATED FROM 'DGMT ENTER/EDIT MARITAL STATUS' INPUT TEMPLATE(#467), FILE 408.22;03/14/16
 D DE G BEGIN
...
X3 S:DGDR'["101" Y="@102"
 Q
4 S DQ=5 ;@101
5 S DW="0;5",DV="RSXR",DU="",DIFLD=.05,DLB="WAS YOUR MARITAL STATUS EITHER MARRIED OR SEPARATED ON DEC 31ST LAST YEAR"
 S DE(DW)="C5^DGMTXM"
 S DU="1:YES;0:NO;"
...
X6 S:'X Y="@102"
 Q
7 D:$D(DG)>9 F^DIE17,DE S DQ=7,DW="0;6",DV="SXR",DU="",DIFLD=.06,DLB="DID YOU LIVE WITH YOUR SPOUSE LAST YEAR"
 S DE(DW)="C7^DGMTXM"
 S DU="1:YES;0:NO;"
 G RE
...
X8 S:X Y="@102"
 Q
9 D:$D(DG)>9 F^DIE17,DE S DQ=9,DW="0;20",DV="SR",DU="",DIFLD=.21,DLB="IF YOUR SPOUSE DID NOT LIVE WITH YOU LAST YEAR, DID YOU PROVIDE SUPPORT"
 S DE(DW)="C9^DGMTXM"
 S DU="1:YES;0:NO;"
 G RE
...
X13 S:DGDR'["102" Y="@998"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="0;8",DV="SXR",DU="",DIFLD=.08,DLB="DID YOU HAVE ANY DEPENDENT CHILDREN"
 S DE(DW)="C14^DGMTXM"
 S DU="1:YES;0:NO;"
