DGMTXT ; GENERATED FROM 'DGMT V1 ENTER/EDIT DEPENDENTS' INPUT TEMPLATE(#1725), FILE 408.22;03/14/16
 D DE G BEGIN
...
X11 S AGE=($$FMDIFF^XLFDT(DT,DOB)/365.25)
 Q
12 S DW="0;9",DV="S",DU="",DIFLD=.09,DLB="PERMANENTLY INCAPABLE OF SELF-SUPPORT"
 S DE(DW)="C12^DGMTXT"
 S DU="1:YES;0:NO;"
 G RE
...
X13 I (AGE<18)!(AGE>23.99999) S Y="@1"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="0;18",DV="S",DU="",DIFLD=.18,DLB="CHILD IS 18-23 YRS AND CHILD ATTENDED SCHOOL LAST YR"
 S DE(DW)="C14^DGMTXT"
 S DU="0:NO;1:YES;"
 S Y="YES"
 G Y
...
X15 S Y="@2"
 Q
16 S DQ=17 ;@1
17 D:$D(DG)>9 F^DIE17,DE S DQ=17,DW="0;18",DV="S",DU="",DIFLD=.18,DLB="CHILD IS 18-23 YRS AND CHILD ATTENDED SCHOOL LAST YR"
 S DE(DW)="C17^DGMTXT"
 S DU="0:NO;1:YES;"
 S Y="NO"
 G Y
...
X17 Q
18 S DQ=19 ;@2
19 D:$D(DG)>9 F^DIE17,DE S DQ=19,DW="0;6",DV="SX",DU="",DIFLD=.06,DLB="DID THE CHILD LIVE WITH YOU"
 S DE(DW)="C19^DGMTXT"
 S DU="1:YES;0:NO;"
 G RE
...
X20 S:X Y="@10"
 Q
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW="0;10",DV="SX",DU="",DIFLD=.1,DLB="DID YOU CONTRIBUTE TO THE CHILD'S SUPPORT"
 S DE(DW)="C21^DGMTXT"
 S DU="1:YES;0:NO;"
 G RE
...
X22 S:'X Y="@10"
 Q
23 S DQ=24 ;@10
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="0;11",DV="SX",DU="",DIFLD=.11,DLB="DID CHILD HAVE ANY INCOME/NET WORTH"
 S DE(DW)="C24^DGMTXT"
 S DU="1:YES;0:NO;"
 G RE
...
X25 S:'X Y="@998"
 Q
26 D:$D(DG)>9 F^DIE17,DE S DQ=26,DW="0;12",DV="SX",DU="",DIFLD=.12,DLB=" WAS THE CHILD'S INCOME/NET WORTH AVAILABLE TO YOU"
 S DE(DW)="C26^DGMTXT"
 S DU="1:YES;0:NO;"
 G RE
