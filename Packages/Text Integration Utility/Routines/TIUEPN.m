TIUEPN ; GENERATED FROM 'TIU ENTER/EDIT PROGRESS NOTE' INPUT TEMPLATE(#1493), FILE 8925;07/28/17
 D DE G BEGIN
...
C1F1 S DIEZRXR(8925,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=827 S DIEZRXR(8925,DIXR)=""
 Q
X1 Q
...
C11F1 S DIEZRXR(8925,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=247,827 S DIEZRXR(8925,DIXR)=""
 Q
X11 Q
12 S DQ=13 ;@14
