RACTQE ; GENERATED FROM 'RA QUICK EXAM ORDER' INPUT TEMPLATE(#1086), FILE 75.1;08/16/17
 D DE G BEGIN
DE S DIE="^RAO(75.1,",DIC=DIE,DP=75.1,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^RAO(75.1,DA,""))=""
 ...
 I  S %=$P(%Z,U,20) S:%]"" DE(49)=%,DE(54)=%,DE(58)=% S %=$P(%Z,U,21) S:%]"" DE(39)=%,DE(42)=%,DE(45)=%
...
C2F1 S DIEZRXR(75.1,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=455 S DIEZRXR(75.1,DIXR)=""
 Q
X2 Q
