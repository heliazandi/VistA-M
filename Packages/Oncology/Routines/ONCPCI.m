ONCPCI ;Hines OIFO/GWB - Patient Identification/Cancer Identification screen display ;05/30/00
 ;;2.11;ONCOLOGY;**15,19,24,26,27,28,33,35,36,42,43,44,45,46,47,49**;Mar 07, 1995;Build 38
 ;
...
CI ;Cancer Identification
 K DASH S $P(DASH,"-",80)="-"
 N COC,DI,DIC,DR,DA,DIQ,ONC,TM1,TM2,TM3,DOTS1,DOTS2,DOTS3
 S DIC="^ONCO(165.5,"
 ...
 W !," Histology/Behavior Code......: ",ONC(165.5,D0,22.1)_" "_$E(ONC(165.5,D0,HSTFLD),1,40)
