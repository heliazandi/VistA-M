MAGDRPC8 ;WOIFO/EdM,BT,DAC - RPCs for Master Files ; 22 Dec 2014 9:52 AM
 ;;3.0;IMAGING;**11,30,51,54,118,138,156**;Mar 19, 2002;Build 10;Jul 31, 2013
...
UPDTAPP(OUT,APP) ; RPC = MAG DICOM UPDATE SCU LIST
 ...
 . Q:A["_"
 . S X=APP(A) F I=1:1:9 S:$P(X,"^",I)="" N=N+1 ; P156 DAC 
 . S:GWNAM="" GWNAM=$P(X,"^",5)
 . S:GWLOC="" GWLOC=$P(X,"^",7)
 . S:GWNAM'=$P(X,"^",5) N=N+1
 . S:GWLOC'=$P(X,"^",7) N=N+1
