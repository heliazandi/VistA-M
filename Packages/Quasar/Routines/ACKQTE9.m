...
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,D=0 K DE(1) ;10
 S DIFLD=10,DGO="^ACKQTE10",DC="6^509850.61PA^3^",DV="509850.61M*P509850.4'X",DW="0;1",DOW="PROCEDURE CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="ACK(509850.4,"
...
X12 D EVNTDIS^ACKQUTL5
 Q
13 S D=0 K DE(1) ;15
 S DIFLD=15,DGO="^ACKQTE11",DC="4^509850.615PA^7^",DV="509850.615M*P725'X",DW="0;1",DOW="EVENT CAPTURE PROCEDURE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="EC(725,"
